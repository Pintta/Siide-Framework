...
RegisterNetEvent('carwash:client:washCar')
AddEventHandler('carwash:client:washCar', function()
    local PlayerPed = GetPlayerPed(-1)
    local PedVehicle = GetVehiclePedIsIn(PlayerPed)
    local Driver = GetPedInVehicleSeat(PedVehicle, -1)
    ...
    rg.toiminnot.Progressbar("search_cabin", "Pestään ajoneuvoa..", math.random(8000, 28000), false, true, {
