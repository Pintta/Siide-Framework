...
rg.toiminnot.CreateCallback('fishing:GetItemData', function(source, cb, itemName)
	local retval = false
...
rg.toiminnot.CreateUseableItem("fishingrod", function(source, item)
    local Player = rg.toiminnot.GetPlayer(source)
...
AddEventHandler("fishing:sellFish", function()
    ...
    if Player.PlayerData.items ~= nil and next(Player.PlayerData.items) ~= nil then 
		...
		TriggerClientEvent('rg:Ilmoitus', src, "You have sold your fish")
	end
end)