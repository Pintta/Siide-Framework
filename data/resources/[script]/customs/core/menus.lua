...
Config.Menus = {
    ...
    ['main'] = {
        title = 'TALLI',
        options = {
            {label = 'Korjaus',                         img = 'img/icons/repair.png',           price = Config.VehicleRepairPrice, onSelect = function() repairtVehicle(customVehicle) end},
            {label = 'Visuaali',                        img = 'img/icons/visual.png',           openSubMenu = 'visual'},
            {label = 'Päivitys',                        img = 'img/icons/upgrade.png',          openSubMenu = 'upgrade'}
        },
        ...
        ['upgrade'] = {
            title = 'PÄIVITYKSET',
            options = {
                {label = 'Moottori',                    img = 'img/icons/engine.png',           modType = 11, priceMult = Config.VehicleCustomisePriceMultiplier['engine']},
                {label = 'Jarru',                       img = 'img/icons/brakes.png',           modType = 12, priceMult = Config.VehicleCustomisePriceMultiplier['brakes']},
                {label = 'Vaihdelaatikko',              img = 'img/icons/transmission.png',     modType = 13, priceMult = Config.VehicleCustomisePriceMultiplier['transmission']},
                {label = 'Alusta',                      img = 'img/icons/suspension.png',       modType = 15, priceMult = Config.VehicleCustomisePriceMultiplier['suspension']},
        ...
        ['visual'] = {
            title = 'VISUAALIT',
            options = {
                {label = 'Koriosat',                    img = 'img/icons/body.png',             openSubMenu = 'body_parts'},
                {label = 'Kori',                        img = 'img/icons/body.png',             openSubMenu = 'inside_parts'},
                {label = 'Maali',                       img = 'img/icons/respray.png',          openSubMenu = 'respray'},
                {label = 'Vanne',                       img = 'img/icons/wheel.png',            openSubMenu = 'wheels', onSelect = function()
                    moveToCameraToBoneSmoth(customCamMain, customCamSec, customVehicle, 'wheel_lf', {x = -1.8, y = 0.0, z = 0.0}, {x = 0.0, y = 0.0, z = -20.0})
                end},
                {label = 'Kilpi',                       img = 'img/icons/plate.png',            openSubMenu = 'plate'},
                {label = 'Valo',                        img = 'img/icons/headlights.png',       openSubMenu = 'lights'},
                {label = 'Teippi',                      img = 'img/icons/respray.png',          openSubMenu = 'stickers'},
                {label = 'Lisärit',                     img = 'img/icons/plus.png',             modType = 'extras',                                     priceMult = Config.VehicleCustomisePriceMultiplier['extras']},
                {label = 'Tummennus',                   img = 'img/icons/door.png',             modType = 'windowTint',                                 priceMult = Config.VehicleCustomisePriceMultiplier['windowTint'], onSelect = function()
                ...
                {label = 'Töötti',                      img = 'img/icons/horn.png',             modType = 14,                                           priceMult = Config.VehicleCustomisePriceMultiplier['horn']},
                {label = 'Äänentoisto',                 img = 'img/icons/speaker.png',          modType = 36,                                           priceMult = Config.VehicleCustomisePriceMultiplier['speakers']},
                {label = 'Takakontti',                  img = 'img/icons/trunk.png',            modType = 37,                                           priceMult = Config.VehicleCustomisePriceMultiplier['trunk'], onSelect = function() openDoors(customVehicle, {0,0,0,0,0,1,1}) end},
                {label = 'Hydrauliikka',                img = 'img/icons/hydrulics.png',        modType = 38,                                           priceMult = Config.VehicleCustomisePriceMultiplier['hydrulics']},
                {label = 'Moottorilohko',               img = 'img/icons/engine_block.png',     modType = 39,                                           priceMult = Config.VehicleCustomisePriceMultiplier['engine_block'], onSelect = function() openDoors(customVehicle, {0,0,0,0,1,0,0}) end},
                {label = 'Ilmansuodatin',               img = 'img/icons/air_filter.png',       modType = 40,                                           priceMult = Config.VehicleCustomisePriceMultiplier['air_filter']},
                {label = 'Tukivarret',                  img = 'img/icons/suspension.png',       modType = 41,                                           priceMult = Config.VehicleCustomisePriceMultiplier['struts']},
                {label = 'Säiliö',                      img = 'img/icons/gas_tank.png',         modType = 45,                                           priceMult = Config.VehicleCustomisePriceMultiplier['tank']},
            },
            onBack = function() updateMenu('main') end
        },
            ['body_parts'] = {
                title = 'KORISARJA',
                options = {
                    {label = 'Spoilerit',               img = 'img/icons/spoiler.png',          modType = 0,                                            priceMult = Config.VehicleCustomisePriceMultiplier['spoilers']},
                    {label = 'Etupuskuri',              img = 'img/icons/bumper.png',           modType = 1,                                            priceMult = Config.VehicleCustomisePriceMultiplier['front_bumper']},
                    {label = 'Takapuskuri',             img = 'img/icons/bumper.png',           modType = 2,                                            priceMult = Config.VehicleCustomisePriceMultiplier['rear_bumper'], onSelect = function()
                        moveToCameraToBoneSmoth(customCamMain, customCamSec, customVehicle, 'bumper_r', {x = 0.0, y = -4.0, z = 1.5}, {x = -30.0, y = 0.0, z = 0.0})
                    end, onSubBack = function()
                        SetCamActiveWithInterp(customCamMain, customCamSec, 500, true, true)
                    end},
                    {label = 'Sivuhelmat',              img = 'img/icons/bumper.png',           modType = 3,                                            priceMult = Config.VehicleCustomisePriceMultiplier['side_skirts'], onSelect = function()
                        moveToCameraToBoneSmoth(customCamMain, customCamSec, customVehicle, 'wheel_lf', {x = -2.5, y = 0.0, z = 0.0}, {x = 0.0, y = 0.0, z = -20.0})
                    end, onSubBack = function()
                        SetCamActiveWithInterp(customCamMain, customCamSec, 500, true, true)
                    end},
                    {label = 'Pakosarja',               img = 'img/icons/exhaust.png',          modType = 4,                                            priceMult = Config.VehicleCustomisePriceMultiplier['exhaust'], onSelect = function()
                        moveToCameraToBoneSmoth(customCamMain, customCamSec, customVehicle, 'bumper_r', {x = 0.0, y = -4.0, z = 1.5}, {x = -30.0, y = 0.0, z = 0.0})
                    end, onSubBack = function()
                        SetCamActiveWithInterp(customCamMain, customCamSec, 500, true, true)
                    end},
                    {label = 'Turvakaari',              img = 'img/icons/body.png',             modType = 5,                                            priceMult = Config.VehicleCustomisePriceMultiplier['cage'], onSelect = function()
                        moveToCameraToBoneSmoth(customCamMain, customCamSec, customVehicle, 'interiorlight', {x = 0.0, y = 1.0, z = -0.1}, {x = 0.0, y = 0.0, z = 0.0})
                    end, onSubBack = function()
                        SetCamActiveWithInterp(customCamMain, customCamSec, 500, true, true)
                    end},
                    {label = 'Ritilä',                  img = 'img/icons/grille.png',           modType = 6,                                            priceMult = Config.VehicleCustomisePriceMultiplier['grille']},
                    {label = 'Konepelti',               img = 'img/icons/hood.png',             modType = 7,                                            priceMult = Config.VehicleCustomisePriceMultiplier['hood']},
                    {label = 'Vasen lokasuoja',         img = 'img/icons/bumper.png',           modType = 8,                                            priceMult = Config.VehicleCustomisePriceMultiplier['left_fender']},
                    {label = 'Oikea lokasuoja',         img = 'img/icons/bumper.png',           modType = 9,                                            priceMult = Config.VehicleCustomisePriceMultiplier['right_fender']},
                    {label = 'Katto',                   img = 'img/icons/roof.png',             modType = 10,                                           priceMult = Config.VehicleCustomisePriceMultiplier['roof']},
                    {label = 'Kaari',                   img = 'img/icons/bumper.png',           modType = 42,                                           priceMult = Config.VehicleCustomisePriceMultiplier['arch_cover']},
                    ...
                    {label = 'Ikkuna',                  img = 'img/icons/door.png',             modType = 46,                                           priceMult = Config.VehicleCustomisePriceMultiplier['windows']},
                },
