cfg = {
	...
	classDamageMultiplier = {[0] = 1.0, 1.0, 1.0, 0.95, 1.0, 0.95, 0.95, 0.95, 0.27, 0.7, 0.25, 0.35, 0.85, 1.0, 0.4, 0.7, 0.7, 0.75, 0.85, 0.67, 0.43, 1.0}
}
...
repairCfg = {
	...
	fixMessageCount = 5,
	noFixMessages = {"You can't fix mistakes you have not made"},
	noFixMessageCount = 1
}
