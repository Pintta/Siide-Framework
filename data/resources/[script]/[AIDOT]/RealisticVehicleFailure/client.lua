...
Citizen.CreateThread(function()
	while rg == nil do
		TriggerEvent('rg:getSharedObject', function(obj) rg = obj end)
		Citizen.Wait(0)
	end
	while rg.GetPlayerData().job == nil do
		Citizen.Wait(10)
	end
	PlayerData = rg.GetPlayerData()
end)

RegisterNetEvent('rg:setJob')
AddEventHandler('rg:setJob', function(job)
  PlayerData.job = job
end)
