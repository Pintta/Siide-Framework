...
AddEventHandler('pings:client:DoPing', function(id)
    ...
    if not exports['police']:IsHandcuffed() then
        ...
        rg.toiminnot.Notify('You can\'t ping at the moment.', 'error')
    end
end)

RegisterNetEvent('pings:client:AcceptPing')
AddEventHandler('pings:client:AcceptPing', function(PingData, SenderData)
    ...
    if not exports['police']:IsHandcuffed() then
        ...
        rg.toiminnot.Notify('You can\'t accept the ping at the moment.', 'error')
    end
end)

RegisterNetEvent('pings:client:SendLocation')
AddEventHandler('pings:client:SendLocation', function(PingData, SenderData)
    rg.toiminnot.Notify('The location has been set on your GPS.', 'success')
    ...
    SetBlipColour(CurrentPings[PingData.sender], 81)
    ...
    SetTimeout(5 * (60 * 1000), function()
        rg.toiminnot.Notify('Ping '..PingData.sender..' Pin has expired..', 'error')
