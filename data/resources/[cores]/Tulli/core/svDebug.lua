RegisterServerEvent('rg:DebugSomething')
AddEventHandler('rg:DebugSomething', function(resource, obj, depth)
...
rg.Debug = function(resource, obj, depth)
    TriggerEvent('rg:DebugSomething', resource, obj, depth)
end

rg.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

rg.ShowSuccess = function(resource, msg)
